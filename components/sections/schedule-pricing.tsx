    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6">
          <ScheduleCard title="Orario Settimanale" subtitle="A.S.D. Dancesport Studio" schedule={salaArmoniaSchedule} />
        </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-16 px-4 text-left lg:px-0 lg:text-center">
          ...
          <p className="max-w-none text-lg text-pretty text-foreground lg:mx-auto lg:max-w-2xl">
            Scegli la formula piu adatta a te. Per informazioni sui costi contattaci direttamente.
          </p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="mb-4 text-sm text-muted-foreground italic">
            Vuoi sapere di piu? Contattaci per un preventivo personalizzato - la prima lezione e gratuita.
          </p>
