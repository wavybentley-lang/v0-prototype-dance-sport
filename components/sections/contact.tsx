...
const ageOptions = ["3-5 anni", "6-9 anni", "10-13 anni", "14-17 anni", "18+ anni"]
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 px-4 text-left lg:px-0 lg:text-center">
            <h2 className="mb-4 text-left font-serif text-4xl font-bold text-foreground sm:text-5xl md:text-6xl lg:text-center">
              Prenota la tua <span className="text-primary">lezione di prova</span>
            </h2>
            <p className="max-w-none text-lg text-pretty text-foreground lg:mx-auto lg:max-w-2xl">
              Compila il modulo e il nostro staff ti contattera per aiutarti a scegliere il corso piu adatto e prenotare la tua lezione di prova gratuita.
            </p>
          </div>
            ...
            {formSubmitted ? (
              ...
              <form
                ...
                onSubmit={async (event) => {
                  ...
                  const fasciaEta = (form.elements.namedItem("fasciaEta") as HTMLInputElement).value
                  ...
                  if (!fasciaEta) errors.fasciaEta = true
              ...
              >
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  ...
                  <div>
                    <label htmlFor="age-range" className="mb-2 block text-[12px] font-semibold tracking-wider text-white uppercase">
                      Fascia d'eta
                    </label>
                    <select
                      id="age-range"
                      ...
                      onChange={(event) => {
                        ...
                        setFormErrors((previous) => ({ ...previous, fasciaEta: false }))
                      }}
                      className="w-full rounded-xl bg-[#0A0A0A] px-4 py-3 text-white shadow-[0_12px_32px_rgba(0,0,0,0.28)] transition-[border-color,box-shadow] focus:border-[rgba(212,175,55,0.75)] focus:shadow-[0_0_0_3px_rgba(212,175,55,0.12),0_12px_32px_rgba(0,0,0,0.28)] focus:outline-none"
                      style={{ border: `1px solid ${formErrors.fasciaEta ? "var(--template-error)" : "rgba(212,175,55,0.25)"}` }}
                    >
                      <option value="" disabled>
                        Seleziona la fascia d'eta
                      </option>
